...
def detect_user_or_bot(movement_data):
    # Define bot-like clusters
    bot_clusters = [1, 2, 3, 4, 8]  # These clusters exhibit higher acceleration and jerk
...
# Simulate movements
movement_data = simulate_movements(duration=15, bot=True)  # Change bot=False for human-like, bot=True for bot-like movements
